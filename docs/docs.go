    ...
    "paths": {
        "/attraction/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "CreateAttractionReq JSON",
                        "name": "CreateAttractionReq",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/req.CreateAttractionReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/reservation/filter": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "example": "UPCOMING | COMPLETED | CANCELLED",
                        "x-order": "2",
                        "name": "status",
                        "in": "query"
                    },
